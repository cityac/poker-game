...
import PlayerCard from '~/components/Game.1/PlayerCard/PlayerCard';
import Flop from '~/components/Game.1/Flop/Flop';
...
import Chat from '../../components/Game.1/Chat/Chat';
import Prizepool from '../../components/Game.1/Prizepool/Prizepool';
