...
import PlayerCard from '~/components/Game.2/PlayerCard/PlayerCard';
import Flop from '~/components/Game.2/Flop/Flop';
...
import Chat from '../../components/Game.2/Chat/Chat';
import Prizepool from '../../components/Game.2/Prizepool/Prizepool';
