...
import PlayerCard from '~/components/Game.6/PlayerCard/PlayerCard';
import Flop from '~/components/Game.6/Flop/Flop';
...
import Chat from '../../components/Game.6/Chat/Chat';
import Prizepool from '../../components/Game.6/Prizepool/Prizepool';
