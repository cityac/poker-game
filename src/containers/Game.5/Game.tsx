...
import PlayerCard from '~/components/Game.5/PlayerCard/PlayerCard';
import Flop from '~/components/Game.5/Flop/Flop';
...
import Chat from '../../components/Game.5/Chat/Chat';
import Prizepool from '../../components/Game.5/Prizepool/Prizepool';
