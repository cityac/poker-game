...
import PlayerCard from '~/components/Game.4/PlayerCard/PlayerCard';
import Flop from '~/components/Game.4/Flop/Flop';
...
import Chat from '../../components/Game.4/Chat/Chat';
import Prizepool from '../../components/Game.4/Prizepool/Prizepool';
